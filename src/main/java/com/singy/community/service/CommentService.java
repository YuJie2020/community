...
import com.singy.community.dao.CommentMapper;
...
public class CommentService implements CommunityConstant {
    ...
    public int addComment(Comment comment) {
        ...
        if (comment.getEntityType() == ENTITY_TYPE_POST) {
            int count = commentMapper.selectCountByEntity(comment.getEntityType(), comment.getEntityId()); // 评论的entityId即为帖子的id
